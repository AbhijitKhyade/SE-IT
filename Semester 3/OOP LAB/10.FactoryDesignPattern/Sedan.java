...
public class Sedan extends Car{
    ...
    void constructCar() {
        ...
        System.out.println("Constructing the Sedan car.");
    }
    ...
    void brand() {
        ...
        switch (Brand) {
            case "Tata":
                System.out.println("Sedan Tata car is constructing");
                break;
            case "Honda":
                System.out.println("Sedan Honda car is constructing");
                break;
            case "Toyota":
                System.out.println("Sedan Toyota car is constructing");
                break;
            case "Mahindra":
                System.out.println("Sedan Mahindra car is constructing");
                break;
        }
    }
}
